...
export function createCommandFiles(): boolean {
  ...
  writeFileSync(join(OPENCODE_COMMAND_DIR, "supermemory-init.md"), SUPERMEMORY_INIT_COMMAND);
  console.log(`✓ Created /supermemory-init command`);

  writeFileSync(join(OPENCODE_COMMAND_DIR, "supermemory-login.md"), SUPERMEMORY_LOGIN_COMMAND);
  console.log(`✓ Created /supermemory-login command`);

  writeFileSync(join(OPENCODE_COMMAND_DIR, "supermemory-logout.md"), SUPERMEMORY_LOGOUT_COMMAND);
